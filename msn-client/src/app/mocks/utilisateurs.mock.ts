...
export const USERS : Utilisateur[] = [
    new Utilisateur(1, 'John Doe','john@example', 'online', null,'1','https://i.redd.it/windows-xp-user-icons-part-1-v0-21x236nw74qb1.jpg?width=1117&format=pjpg&auto=webp&s=373255f32cfaeaf801f1e3ae36dc314dd6b1f100',null),
